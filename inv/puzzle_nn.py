...
#            print(tup, value)
    ...
    def pdb_heuristic(self, id):
        ...
        tup = tuple([abstract(x) for x in self.board])  # creamos una tupla reemplazando por -1
        return max(Puzzle.pdb[id][tup], self.manhattan())                    # a todo elemento que no esta en pattern
